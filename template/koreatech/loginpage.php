...
<div id=main>
        ...
        <?php if($OJ_VCODE){?>
                <tr><td><?php echo $MSG_VCODE?>:</td>
                        <td><input name="vcode" size=4 type=text style="height:24px"><img alt="click to change" src='vcode.php?<?php echo rand();?> onclick="this.src='vcode.php?<?php echo rand();?>#'+Math.random()">*</td>
                </tr>
                <?php }?>
